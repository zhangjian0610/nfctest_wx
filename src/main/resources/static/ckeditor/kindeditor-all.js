...
(function(window, undefined) {
	...
	K.options = {
		...
		items : [ 'source', '|', 'undo', 'redo', '|', 'preview',
				...
				'strikethrough', 'lineheight', 'removeformat', '|', 'insertfile', 'table', 'hr',
		...
		.plugin(
				...
				function(K) {
					var self = this, name = 'image', allowImageUpload = K
							...
							.undef(self.uploadJson, self.basePath
									+ 'upload/down'), imageTabIndex = K.undef(
							self.imageTabIndex, 0), imgPath = self.pluginsPath
		...
		.plugin(
				...
				function(K) {
					var self = this, name = 'insertfile', allowFileUpload = K
							...
							.undef(self.uploadJson, self.basePath
									+ 'upload/down'), extraParams = K.undef(
							self.extraFileUploadParams, {}), filePostName = K
							.undef(self.filePostName, 'imgFile'), lang = self
							.lang(name + '.');
...
KindEditor.plugin('multiimage', function(K) {
	var self = this, name = 'multiimage', formatUploadUrl = K.undef(
			...
			self.basePath + 'upload/down'), imgPath = self.pluginsPath

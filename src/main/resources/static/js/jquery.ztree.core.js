		...
		view = {
			...
			makeNodeIcoStyle: function(setting, node) {
				...
				if(!node.isAjaxing) {
					...
					//if (icon) icoStyle.push("background:url(", icon, ") 0 0 no-repeat;"); //edit
			...
			replaceSwitchClass: function(node, obj, newName) {
				...
				switch(newName) {
					case consts.folder.OPEN:
						diyicon = "glyphicon glyphicon-chevron-down";
						break;
					case consts.folder.CLOSE:
						diyicon = "glyphicon glyphicon-chevron-right";
						break;
				}
				obj.attr("class", tmpList.join("_")+" "+ diyicon);
